...
export default async function SettingsPage({
  ...
  return (
    <div>
      ...
      {params.imported ? (
        <p className="mb-4 rounded-xl bg-ok-soft px-3 py-2 text-sm text-ok">Data cadangan berhasil diimpor. Katalog, shift, dan transaksi sudah diganti.</p>
      ) : null}
      <div className="grid grid-cols-1 items-stretch gap-6 lg:grid-cols-12">
        <form action={saveSettings} className="contents">
          <div className="flex min-w-0 flex-col gap-6 lg:col-span-5">
            ...
            <Card className="relative isolate overflow-hidden">
              ...
              <p className="mt-1 mb-3 text-sm text-muted">Reset memakai palet mode: F&amp;B cokelat, retail biru.</p>
              <AccentColorPicker value={accent} defaultColor={defaultAccent(current)} />
            </Card>
          </div>
          <Card className="relative isolate min-w-0 overflow-hidden lg:col-span-7 lg:row-span-2">
        ...
        <Card className="relative isolate min-w-0 overflow-hidden lg:col-span-5">
          <h2 className="text-lg font-semibold">Cadangan</h2>
          <p className="mt-1 text-sm text-muted">
            Ekspor seluruh data toko ke JSON, atau impor seed F&amp;B demo (transaksi 1–22 September 2026). Impor mengganti
            katalog, stok, shift, dan transaksi. Akun login tetap.
          </p>
          <div className="mt-3 flex flex-wrap gap-2">
            <a href="/api/backup" className={ghostButtonClass}>
              Unduh backup JSON
            </a>
            <a href="/api/backup/fnb-demo" className={ghostButtonClass}>
              Unduh seed F&amp;B demo
            </a>
          </div>
          <ImportBackupForm />
